...
INSERT INTO `authors` (`id`, `name`, `email`) VALUES (1,'test1','test1@test.com'),(2,'test2','test2@test.com'),(3,'test3','test3@test.com'),(4,'test4','test4@test.com'),(5,'test5','test5@test.com');
...
-- Dump completed on 2022-06-11 11:18:37
